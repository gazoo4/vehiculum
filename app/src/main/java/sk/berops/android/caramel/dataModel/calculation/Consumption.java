package sk.berops.android.caramel.dataModel.calculation;
...
import sk.berops.android.caramel.dataModel.expense.Entry.ExpenseType;
import sk.berops.android.caramel.engine.charts.IntoPieChartExtractable;
...
public class Consumption implements IntoPieChartExtractable, Serializable {
	...
	public void reloadChartData(int depth) {
		...
		int i = 0;
		for (sk.berops.android.caramel.dataModel.expense.Entry.ExpenseType t : sk.berops.android.caramel.dataModel.expense.Entry.ExpenseType.values()) {
