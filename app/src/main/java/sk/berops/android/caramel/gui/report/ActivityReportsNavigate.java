...
import sk.berops.android.caramel.dataModel.expense.History;
import sk.berops.android.caramel.engine.charts.ExpenseDistributionPieChart;
...
public class ActivityReportsNavigate extends DefaultActivity {
    ...
    private void updateDescription(int typeId) {
        ...
        if (typeId == -1) {
            ...
            sk.berops.android.caramel.dataModel.expense.Entry.ExpenseType type = sk.berops.android.caramel.dataModel.expense.Entry.ExpenseType.getExpenseType(typeId);
